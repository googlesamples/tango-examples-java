...
public class Renderer  {
	...
	public void updateViewMatrix() {
		...
		case THIRD_PERSON:
			...
			Matrix.setLookAtM(mViewMatrix, 0, mDevicePosition[0]+mCameraPosition[0], mCameraPosition[1] + mDevicePosition[1], 
					mCameraPosition[2] + mDevicePosition[2], mDevicePosition[0], mDevicePosition[1], 
					mDevicePosition[2], 0f, 1f, 0f);	
			break;
		case TOP_DOWN:
			//Matrix.setIdentityM(mViewMatrix, 0);
