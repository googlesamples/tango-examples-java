 ...
 */
public class MyTrajectory extends Renderable {
    ...
    private static final String TAG = MyTrajectory.class.getSimpleName();
    ...
    public MyTrajectory(int lineWidth) {
    ...
    public MyTrajectory(int lineWidth, float[] color) {
        mLineWidth = lineWidth;
        mColor = color;
        // Reset the model matrix to the identity
        Matrix.setIdentityM(getModelMatrix(), 0);
